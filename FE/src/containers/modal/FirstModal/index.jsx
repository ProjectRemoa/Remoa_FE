...
import Agree from "../../sociallogin/Agree";
...
export default function FirstModal({
  ...
  return (
    <S.ModalWrapper style={{display: isFirstModalOpen ? "flex" : "none"}}>
      <S.Modal>
        <S.Box>
        ...
        <S.ButtonBox>
          <S.Button disabled={!buttonColor} state={buttonColor} onClick={handleFirstModalClose}>
            레모아 시작하기
          </S.Button>
        </S.ButtonBox>
      </S.Modal>
