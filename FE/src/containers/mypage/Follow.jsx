...
function Follow() {
  ...
  const [followInfo, setFollowInfo] = useState({
    ...
    followingIntro: (
      <Style.FollowNum>
        <Style.Text>{username}</Style.Text>님이 팔로우하고 있는 유저는 총&nbsp;
        <Style.Text>{followingNum}</Style.Text>명 입니다
      </Style.FollowNum>
    ),
    followerIntro: (
      <Style.FollowNum>
        총&nbsp;<Style.Text>{followerNum}</Style.Text>명이&nbsp;
        <Style.Text>{username}</Style.Text>님을 팔로잉하고 있어요
      </Style.FollowNum>
    ),
  });

  //const { followingColor, followerColor, followingIntro, followerIntro } =
  //followInfo;
  ...
  const followingPage = () => {
    ...
    setFollowInfo({
      ...
      followingIntro: (
        <Style.FollowNum>
          <Style.Text>{username}</Style.Text>님이 팔로우하고 있는 유저는
          총&nbsp;<Style.Text>{followingNum}</Style.Text>명 입니다
        </Style.FollowNum>
      ),
      followerIntro: null,
    });
    ...
    <>
      <Style.Wrap>
        <Style.HeaderWrap>
          ...
          {following === true
            ? followInfo.followingIntro
            : followInfo.followerIntro}
        </Style.HeaderWrap>
        <Style.FollowList>
